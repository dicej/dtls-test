// This is a very simple test for OpenSSL's DTLS support.  It uses a
// memory BIO, which allows us to abstract away the network and
// simulate packet loss in a controlled way for testing.
